/**
 * <%= responseName %> Server Response, <%= statusCode %> 
 *
 * Usage:
...
module.exports = function <%= responseName %>(validationErrors, redirectTo) {
  ...
  // indicating the status with relevant information will be returned. 
  if (req.wantsJSON) {
